...
- Example directory: [`go/tool-policy`](https://github.com/ai-agent-assembly/examples/tree/HEAD/go/tool-policy)
- [`README.md`](https://github.com/ai-agent-assembly/examples/blob/HEAD/go/tool-policy/README.md)
