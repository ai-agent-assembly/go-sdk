...
- Example directory: [`go/cli-runtime-integration`](https://github.com/ai-agent-assembly/examples/tree/HEAD/go/cli-runtime-integration)
- [`README.md`](https://github.com/ai-agent-assembly/examples/blob/HEAD/go/cli-runtime-integration/README.md)
